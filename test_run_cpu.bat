...
REM set "GRID=%CD%\easyWave-master-data\data\grids\e2Asean.grd"
...
cd outputs-cpu
..\build\easywave-sycl.exe -verbose -grid "%GRID%" -source "%SOURCE%" -ssh_eta -poi %poi% -time 480 -step 1 -progress 1
cd ..
